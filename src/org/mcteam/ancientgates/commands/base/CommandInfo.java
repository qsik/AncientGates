...
public class CommandInfo extends BaseCommand {
	...
	public void perform() {
		...
		if (id == null) {
			...
			Set<Material> blockTypes = new HashSet<Material>();
			blockTypes.add(Material.AIR);
			WorldCoord playerTargetCoord = new WorldCoord(player.getTargetBlock(blockTypes, 20));
